	...
	render(){
		return (
			<UbContent className='page-content'>
				...
				<BoxComponent keyword='border-top-left-radius' pro='左上角' code={[ {path:'css/style/border/border-radius/border-top-left-radius'} ]}>
					<CaseComponent
				...
				<BoxComponent keyword='border-top-right-radius' pro='右上角' code={[ {path:'css/style/border/border-radius/border-top-right-radius'} ]}>
					<CaseComponent
				...
				<BoxComponent keyword='border-bottom-right-radius' pro='右下角' code={[ {path:'css/style/border/border-radius/border-bottom-right-radius'} ]}>
					<CaseComponent
				...
				<BoxComponent keyword='border-bottom-left-radius' pro='左下角' code={[ {path:'css/style/border/border-radius/border-bottom-left-radius'} ]}>
					<CaseComponent
