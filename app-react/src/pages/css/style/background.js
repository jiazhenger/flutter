	...
	render(){
		return (
			<UbContent className='page-content'>
				<BoxComponent order={1} keyword='background-color' pro='背景颜色' code={[ {path:'css/style/background/background-color'} ]}>
					<CaseComponent
				...
				<BoxComponent order={2} keyword='background-image' pro='背景图片' code={[ {path:'css/style/background/background-image'} ]}>
					<CaseComponent
				...
				<BoxComponent order={3} keyword='background-repeat' pro='背景图片平铺' code={[ {path:'css/style/background/background-repeat'} ]}>
					<CaseComponent
				...
				<BoxComponent order={4} keyword='background-position' pro='背景图片位置' code={[ {path:'css/style/background/background-position'} ]}>
					<CaseComponent
				...
				<BoxComponent order={5} keyword='background-attachment' pro='背景滚动' code={[ {path:'css/style/background/background-attachment'} ]}>
					<CaseComponent
				...
				<BoxComponent order={6} keyword='background-size' pro='背景图片大小' code={[ {path:'css/style/background/background-size'} ]}>
					<CaseComponent
				...
				<BoxComponent order={7} keyword='background-clip' isGray pro='指定对象的背景图像向外裁剪的区域' code={[ {path:'css/style/background/background-clip'} ]}>
					<CaseComponent
				...
				<BoxComponent order={8} keyword='background-origin' isGray pro='指定对象的背景图像向外裁剪的区域' code={[ {path:'css/style/background/background-origin'} ]}>
					<CaseComponent
